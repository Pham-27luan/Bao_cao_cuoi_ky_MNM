...
<body class="font-['Inter']">
    ...
    <div id="busModal" class="modal route-modal bus-modal">
        <div class="modal-content route-modal-panel bus-modal-panel">
            <div class="route-modal-header">
                <div>
                    <p class="route-modal-kicker">Quản lý xe</p>
                    <h2 class="modal-header" id="modalTitle">Thêm xe mới</h2>
                </div>
                <button type="button" onclick="closeBusModal()" class="modal-close-btn" aria-label="Đóng">
            ...
            <form id="busForm" method="POST" action="{{ route('admin.buses.store') }}">
                ...
                <div class="route-form-grid bus-form-grid">
                ...
                <div class="modal-footer route-modal-actions">
                    <button type="button" onclick="closeBusModal()" class="btn-outline">Hủy</button>
